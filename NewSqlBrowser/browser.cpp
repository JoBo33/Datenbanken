...
Browser::Browser(QWidget *parent) : QWidget(parent)
{
    ...
    connect(table, SIGNAL (clicked), table, SLOT (tableClicked));
...
void Browser::updateActions()
{
    ...
    bool enableIns = true; //tm;
    bool enableDel = enableIns && table->currentIndex().isValid();

    insertRowAction->setEnabled(enableIns); //enable specific Actions for the table model
    deleteRowAction->setEnabled(enableDel); //enable specific Actions for the table model
                                            //enable specific Actions for the table model
    fieldStrategyAction->setEnabled(tm);    //enable specific Actions for the table model
    rowStrategyAction->setEnabled(tm);      //enable specific Actions for the table model
    manualStrategyAction->setEnabled(tm);   //enable specific Actions for the table model
    submitAction->setEnabled(tm);           //enable specific Actions for the table model
    revertAction->setEnabled(tm);           //enable specific Actions for the table model
    selectAction->setEnabled(tm);           //enable specific Actions for the table model
